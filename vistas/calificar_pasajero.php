...
<html>
  ...
  <body>
    ...
    ?>
     ...
     <h3>Calificar al pasajero <?php echo $passenger["nombre"]." ".$passenger["apellido"]  ?> </h3>
   	 <br>
    ...
    <div class="container">
            ...
            <form method="POST" action="/php/puntuar_pasajero.php" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  ...
                  <input type="hidden" name="passenger" value= "<?php echo $passenger["id_usuario"] ?>"> 
